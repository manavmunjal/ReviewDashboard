...
public class ReviewClientControllerTest {
  ...
  public void testAddReview_Success() {
    ...
    ResponseEntity<?> response = controller.addReview(productId, review);
  ...
  /**
   * Tests that {@link ReviewClientController#addReview(String, ReviewDto)} returns a 400 BAD
   * REQUEST when the service throws an {@link IllegalArgumentException}.
   */
  @Test
  public void testAddReview_BadRequest() {
    when(reviewService.addReview(anyString(), any(ReviewDto.class)))
        .thenThrow(new IllegalArgumentException("Invalid product"));

    ResponseEntity<?> response = controller.addReview("123", new ReviewDto());
  ...
  /**
   * Tests that {@link ReviewClientController#getProductAverageRating(String)} returns a 400 BAD
   * REQUEST when the service throws an {@link IllegalArgumentException}.
   */
  @Test
  ...
  /**
   * Tests that {@link ReviewClientController#getProductAverageRating(String)} returns a 500
  ...
  /**
   * Tests that {@link ReviewClientController#getCompanyAverageRating(String)} returns a 400 BAD
   * REQUEST when the service throws an {@link IllegalArgumentException}.
   */
  @Test
  ...
  /**
   * Tests that {@link ReviewClientController#getCompanyAverageRating(String)} returns a 500
   * INTERNAL SERVER ERROR when the service throws an unexpected exception.
   */
  @Test
